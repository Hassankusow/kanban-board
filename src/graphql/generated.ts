...
export type Cards = {
  ...
  id: Scalars['uuid']['output'];
  order_index: Scalars['float8']['output'];
...
export type Cards_Bool_Exp = {
  ...
  id?: InputMaybe<Uuid_Comparison_Exp>;
  order_index?: InputMaybe<Float8_Comparison_Exp>;
...
export type Cards_Inc_Input = {
  order_index?: InputMaybe<Scalars['float8']['input']>;
};
...
export type Cards_Max_Fields = {
  ...
  description?: Maybe<Scalars['String']['output']>;
  id?: Maybe<Scalars['uuid']['output']>;
  order_index?: Maybe<Scalars['float8']['output']>;
  title?: Maybe<Scalars['String']['output']>;
  updated_at?: Maybe<Scalars['timestamptz']['output']>;
};
...
export type UpdateCardPositionMutationVariables = Exact<{
  ...
  order_index: Scalars['float8']['input'];
}>;


export type UpdateCardPositionMutation = { __typename?: 'mutation_root', update_cards_by_pk?: { __typename?: 'cards', id: any, column_id: any, order_index: any } | null };
...
export type UpdateColumnOrderMutation = { __typename?: 'mutation_root', update_columns_by_pk?: { __typename?: 'columns', id: any, order_index: any } | null };

export type UpdateCardAssigneeMutationVariables = Exact<{
  id: Scalars['uuid']['input'];
  assignee?: InputMaybe<Scalars['String']['input']>;
}>;


export type UpdateCardAssigneeMutation = { __typename?: 'mutation_root', update_cards_by_pk?: { __typename?: 'cards', id: any, assignee?: string | null } | null };
...
export type CreateCardMutation = { __typename?: 'mutation_root', insert_cards_one?: { __typename?: 'cards', id: any, title?: string | null, description?: string | null, order_index: any } | null };
...
export type CreateColumnMutation = { __typename?: 'mutation_root', insert_columns_one?: { __typename?: 'columns', id: any, name: string, order_index: any } | null };
...
export type DeleteBoardMutation = { __typename?: 'mutation_root', delete_boards_by_pk?: { __typename?: 'boards', id: any, name: string } | null };
...
export type GetBoardByIdQuery = { __typename?: 'query_root', boards_by_pk?: { __typename?: 'boards', id: any, name: string, columns: Array<{ __typename?: 'columns', id: any, name: string, order_index: any, cards: Array<{ __typename?: 'cards', id: any, title?: string | null, description?: string | null, assignee?: string | null, order_index: any }> }> } | null };

export type GetBoardsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetBoardsQuery = { __typename?: 'query_root', boards: Array<{ __typename?: 'boards', id: any, name: string, columns: Array<{ __typename?: 'columns', id: any, name: string, order_index: any, cards: Array<{ __typename?: 'cards', id: any, content?: string | null, order_index: any }> }> }> };


export const UpdateCardPositionDocument = gql`
    mutation UpdateCardPosition($id: uuid!, $column_id: uuid!, $order_index: float8!) {
  update_cards_by_pk(
    pk_columns: {id: $id}
    _set: {column_id: $column_id, order_index: $order_index}
  ) {
    id
    column_id
    order_index
...
export const UpdateColumnOrderDocument = gql`
    mutation UpdateColumnOrder($id: uuid!, $order_index: float8!) {
  update_columns_by_pk(pk_columns: {id: $id}, _set: {order_index: $order_index}) {
    id
    order_index
  }
}
    `;
export type UpdateColumnOrderMutationFn = Apollo.MutationFunction<UpdateColumnOrderMutation, UpdateColumnOrderMutationVariables>;
 ...
 * });
 */
export function useUpdateColumnOrderMutation(baseOptions?: Apollo.MutationHookOptions<UpdateColumnOrderMutation, UpdateColumnOrderMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateColumnOrderMutation, UpdateColumnOrderMutationVariables>(UpdateColumnOrderDocument, options);
      }
export type UpdateColumnOrderMutationHookResult = ReturnType<typeof useUpdateColumnOrderMutation>;
export type UpdateColumnOrderMutationResult = Apollo.MutationResult<UpdateColumnOrderMutation>;
export type UpdateColumnOrderMutationOptions = Apollo.BaseMutationOptions<UpdateColumnOrderMutation, UpdateColumnOrderMutationVariables>;
export const UpdateCardAssigneeDocument = gql`
    mutation UpdateCardAssignee($id: uuid!, $assignee: String) {
  update_cards_by_pk(pk_columns: {id: $id}, _set: {assignee: $assignee}) {
    id
    assignee
  }
}
    `;
export type UpdateCardAssigneeMutationFn = Apollo.MutationFunction<UpdateCardAssigneeMutation, UpdateCardAssigneeMutationVariables>;

/**
 * __useUpdateCardAssigneeMutation__
 *
 * To run a mutation, you first call `useUpdateCardAssigneeMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateCardAssigneeMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateCardAssigneeMutation, { data, loading, error }] = useUpdateCardAssigneeMutation({
 *   variables: {
 *      id: // value for 'id'
 ...
 * });
 */
export function useUpdateCardAssigneeMutation(baseOptions?: Apollo.MutationHookOptions<UpdateCardAssigneeMutation, UpdateCardAssigneeMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateCardAssigneeMutation, UpdateCardAssigneeMutationVariables>(UpdateCardAssigneeDocument, options);
      }
export type UpdateCardAssigneeMutationHookResult = ReturnType<typeof useUpdateCardAssigneeMutation>;
export type UpdateCardAssigneeMutationResult = Apollo.MutationResult<UpdateCardAssigneeMutation>;
export type UpdateCardAssigneeMutationOptions = Apollo.BaseMutationOptions<UpdateCardAssigneeMutation, UpdateCardAssigneeMutationVariables>;
...
export const CreateCardDocument = gql`
    mutation CreateCard($column_id: uuid!, $title: String!, $description: String!, $order_index: float8!, $assignee: String) {
  insert_cards_one(
    object: {column_id: $column_id, title: $title, description: $description, order_index: $order_index, assignee: $assignee}
  ) {
    id
    title
    description
...
export const CreateColumnDocument = gql`
    mutation CreateColumn($board_id: uuid!, $name: String!, $order_index: float8!) {
  insert_columns_one(
    object: {board_id: $board_id, name: $name, order_index: $order_index}
  ) {
    id
    name
    order_index
...
export const GetBoardByIdDocument = gql`
  ...
  boards_by_pk(id: $id) {
    id
    name
    columns(order_by: {order_index: asc}) {
      id
      name
      order_index
      cards(order_by: {order_index: asc}) {
        id
        title
        description
        assignee
